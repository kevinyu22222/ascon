...
REM
REM Generated by Vivado on Mon Mar 23 01:23:07 -0700 2026
...
echo "xvlog --incr --relax -L uvm -prj ascon_top_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ascon_top_tb_vlog.prj -log xvlog.log
