...
REM
REM Generated by Vivado on Sun Mar 22 18:22:28 -0700 2026
...
echo "xvlog --incr --relax -L uvm -prj ascon_core_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ascon_core_tb_vlog.prj -log xvlog.log
